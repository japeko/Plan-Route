import {
  DEFAULT_ACCOMMODATION_FILTER_RADIUS_METERS,
  DEFAULT_CAMPING_FILTER_RADIUS_METERS,
  DEFAULT_ROUTE_FILTER_RADIUS_METERS,
  FUEL_TYPES,
} from "@poi/shared";
...
export const DEFAULT_POI_FILTERS: PoiFilterOptions = {
  ...
  accommodationRadiusMeters: DEFAULT_ACCOMMODATION_FILTER_RADIUS_METERS,
};
